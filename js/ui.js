...
UI.prototype ={
	...
	streamGraph: function(){
        ...
        this.s = new StreamGraph(this.stream_graph_holder, data, 1900, 2000,this.user);
        this.s.init();
     						   	 ...
     						   	 rows:[
     						   	 	{
     						   	 		...
     						   	 		id:this.user+"_top_ten_artists",
     						   	 			  container:this.tabbed_menu_holder,
     						   	 			      template:"<img src=#ArtistImageLink#><div class='webix_strong'>#ArtistName# <button class='top_ten_artist_button'></button></div> <p>Primary Genre: #ArtistMainGenre#</p> <p>rank: #rank#</p>",
     						   	 			       url:'../data_processor/SampleData/Test2.json',
     						   	 			      select:1
     						   	 			 }
     						   	 	},
     						   	 	{
     						   	 		...
     						   	 		id:this.user+"_top_ten_genres",
     						   	 			  container:this.tabbed_menu_holder,
     						   	 			      template:"<div class='webix_strong'>#Name# <button class='top_ten_artist_button'></button></div> <p>#Relevance#</p>",
