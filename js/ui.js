...
var baseURL='http://mvalluri-001-site1.atempurl.com/api/';
...
// Initializing the forece directed graph
...
//Intializing the artist list for user1 and user2
	artistList: function(){
		webix.ui({
	...
	//Intializing the genre list for user1 and user2
	genreList: function(){
		webix.ui({
	...
	//Intializing the shared timeline
	sharedPool: function(){
		webix.ui({
	...
	//Intializing the tabbed menu for user1 and user2
	tabbedMenu: function(){
